...
if ((resolution >= 2160)); then
  ...
  wlogout --protocol layer-shell -b 5 -T $T_val -B $B_val -c 5 &
  ...
  wlogout --protocol layer-shell -b 5 -T $T_val -B $B_val -c 15 &
  ...
  wlogout --protocol layer-shell -b 3 -T $T_val -B $B_val -c 15 &
else
